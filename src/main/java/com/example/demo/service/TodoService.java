...
public class TodoService {
    ...
    public List<TodoEntity> update(final TodoEntity entity){
        ...
        // * Optional.ifPresent( todo(Optional에 지정한 객체를 뜻함) -> {함수 내용}) : 값이 존재하는 경우에 그 안에 있는 내용을 실행한다고 읽을 수 있으니 null 을 확인할 수 있다.
        // * Optional.isPresent() : 값 존재 여부에 따라 true, false를 반환.
